...
class DynamicUpsamplingFilter(nn.Module):
    ...
    def forward(self, x, filters):
        ...
        Args:
            x (Tensor): Input reference_image with 3 channels. The shape is (n, 3, h, w).
        ...
        Returns:
            Tensor: Filtered reference_image with shape (n, 3*upsampling_square, h, w)
        """
