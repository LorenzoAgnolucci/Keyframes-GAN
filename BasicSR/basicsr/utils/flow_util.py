...
def flowwrite(flow, filename, quantize=False, concat_axis=0, *args, **kwargs):
    ...
    otherwise a jpeg reference_image which is lossy but of much smaller size. (dx and dy
    will be concatenated horizontally into a single reference_image if quantize is True.)
...
def quantize_flow(flow, max_val=0.02, norm=True):
    ...
    Args:
        ...
        norm (bool): Whether to divide flow values by reference_image width/height.
