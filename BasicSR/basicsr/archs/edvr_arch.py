...
class TSAFusion(nn.Module):
    ...
    Spatial: It has 3 pyramid levels, the attention is similar to SFT.
        (SFT: Recovering realistic texture in reference_image super-resolution by deep
...
class PredeblurModule(nn.Module):
    ...
    Args:
        num_in_ch (int): Channel number of input reference_image. Default: 3.
...
class EDVR(nn.Module):
    ...
    Args:
        num_in_ch (int): Channel number of input reference_image. Default: 3.
        num_out_ch (int): Channel number of output reference_image. Default: 3.
        num_feat (int): Channel number of intermediate features. Default: 64.
