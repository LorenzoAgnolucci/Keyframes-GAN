    ...
    def forward(self, tensor_input):
        ...
        Args:
            tensor_input (Tensor): Input tensor with shape (b, 8, h, w).
                8 channels contain:
                [reference reference_image (3), neighbor reference_image (3), initial flow (2)].
...
class SPyNetTOF(nn.Module):
    ...
    def forward(self, ref, supp):
        """
        Args:
            ref (Tensor): Reference reference_image with shape of (b, 3, h, w).
            supp: The supporting reference_image to be warped: (b, 3, h, w).
