...
class SRModel(BaseModel):
    """Base SR model for single reference_image super-resolution."""
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            if with_metrics:
                ...
                for name, opt_ in self.opt['val']['metrics'].items():
                    ...
                    if name == 'lpips':
                        self.metric_results[name] += calculate_lpips(sr_img, gt_img, lpips_net)
                    else:
